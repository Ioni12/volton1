  ...
  var drJs = {
    ...
    gsapTextanim: function () {
      $(document).ready(function () {
        ...
        // Wait for all web fonts to finish loading before measuring/splitting
        // text. Splitting too early (while a fallback font is still showing)
        // bakes in the wrong word widths, causing skewed/misaligned text
